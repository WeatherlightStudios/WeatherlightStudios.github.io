...
[Fortune's algorithm - Wikipedia][fortune-wiki]

[Fortune’s algorithm and implementation][fortune’s algorithm and implementation]

[Fluid Simulation : Unity3D][fluid simulation : unity3d]

[Metaballs and Marching Squares][metaballs and marching squares]

[Gamasutra: Chris Simpson&#39;s Blog - Behavior trees for AI: How they work][gamasutra: chris simpson&#39;s blog - behavior trees for ai: how they work]

[Algorithm Archive · GitBook][algorithm archive � gitbook]

[Water erosion on heightmap terrain][water erosion on heightmap terrain]

[Fast Hydraulic Erosion Simulation and Visualization on GPU][latex8.dvi]

[Interactive Terrain Modeling Using Hydraulic Erosion][hpcg.purdue.edu/bbenes/papers/stava08sca.pdf]

[R-tree - Wikipedia][r-tree - wikipedia]

[Nick's Voxel Blog: Dual Contouring][nick-voxel-blog]

[Fractals: Useful Beauty][fractals-beauty]

[Worley noise][worley-noise]

[Marching Cubes: Procedural World][marching-cubes]
...
[Refactoring.doc][refactoring.doc]
...
[ECS is the future of MMOG Developement Pt.3][mmog-dev]
...
[Computer Graphics Techniques][graphics-techniques]

[Scene Graph][scene-graph]

[Raymarching Distance Fields][raymarching-df]

[A way to visualyze mip-map levels][mip-maps]

[DirectX Tutorials][directx-tuts]

[Mode 7 Pt.1][mode-7]

[OpenGL from Zero to Hero][opengl-zero-hero]

[John Chapman's Graphics Blog][john-chapman]

[Toon Shader][toon-shader]

[My take on shaders: Edge detection image effect – Harry Alisavakis][my take on shaders: edge detection image effect – harry alisavakis]

[Lospec - Free tools and resources for people making pixel art, voxel art and more][lospec - free tools and resources for people making pixel art, voxel art and more]

[Voxel-Based Terrain for Real-Time Virtual Simulations][voxel-terrain]

[Open GL][open-gl]

[Learn OpenGL][learn-opengl]

[3D Cube World Level Generation][3d-world]

[Nick's Voxel Blog: Dual Contouring with OpenCL][nick-openCL]

[Raycasting Engine in C++][ray-engine-cpp]

[Lode's Computer Graphics Tutorial: Raycasting][lode-tuts]

[Motore 3D in C++ - Raycasting Pt.1][motore-raycasting]
...
[Programming from the ground up][ground-up]
...
[Maths Is Fun][maths-fun]

[Math.it][math-it]

[Linear Algebra for Game Developers Pt.1][linear-algebra]

[Understanding Steering Behaviors - Envato Tuts+ Game Development Tutorials][understanding steering behaviors - envato tuts+ game development tutorials]

[Immersive Linear Algebra][immersive-linear-algebra]
...
[Computer Engineering Reference Books Collection][comp-eng-reference]

[Computer Engineering University Course Exams][compe-eng-exams]

[Software Optimization Resources][software-opt]

[My study notes][my study notes]

[Gamasutra: A Adonaac&#39;s Blog - Procedural Dungeon Generation Algorithm][gamasutra: a adonaac&#39;s blog - procedural dungeon generation algorithm]
...
[Entagma: Advanced CG Resources][entagma]

[HoudiniVex - cgwiki][houdinivex - cgwiki]
...
[ROSALIND Problems][rosalind-problems]
...
[refactoring.doc]: https://www.csie.ntu.edu.tw/~r95004/Refactoring_improving_the_design_of_existing_code.pdf
...
[musings]: http://www.gijskaerts.com/wordpress/?p=112
